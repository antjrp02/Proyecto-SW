...
public class ElementoListaRutinas extends JPanel {
	...
	public ElementoListaRutinas(Ventana v,Rutina rutina) {
		...
		JLabel labelFechaNacimiento = new JLabel();
		...
		botonEditar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				//EmegernteEditarUsuario editor=new EmegernteEditarUsuario(ventana,usuario);
